...
INSERT INTO `drug_info` VALUES ('3', 'ct', '湛江', '1', '2', '150', '3', '0', '2022-10-25 14:29:37', '2022-10-25 14:29:37');
...
-- ----------------------------
INSERT INTO `patient_register` VALUES ('3', '6', '王霞', '1', '1', '1', '穷病', '221222 | 111 | 22 | 33333333333 | 44444444444', '1', '0', '2022-10-27 17:42:36', '2022-10-27 17:42:36');
...
CREATE TABLE `storage_in_order_info` (
  ...
  `drug_type_id` int NOT NULL COMMENT '药类型',
  `drug_name` varchar(255) NOT NULL COMMENT '药品名称',
